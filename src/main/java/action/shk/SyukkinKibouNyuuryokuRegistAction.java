...
public class SyukkinKibouNyuuryokuRegistAction extends TsukibetsuShiftNyuuryokuAbstractAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        // 登録・更新処理
        tsukibetsuShiftLogic.registTsukibetsuShift(tsukibetsuShiftDtoListList, loginUserDto, true);
