/**
 * ファイル名：KinmuJissekiNyuryokuKakuninInitAction.java
 *
 * 変更履歴
 ...
 *
 */
public class KinmuJissekiNyuryokuKakuninInitAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        kinmuJissekiForm.setShainId(loginUserDto.getShainId());
        kinmuJissekiForm.setShainName(loginUserDto.getShainName());
