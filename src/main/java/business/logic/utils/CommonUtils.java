...
public class CommonUtils {
    ...
    public String getMaxId(String tableName) throws SQLException {
        ...
        if (M_shain.TABLE_NAME.getName().equals(tableName)) {
            // 社員マスタ
            idName = M_shain.SHAIN_ID.getName();
    ...
    public static String getFisicalDay() {
        ...
        rtn.append(padWithZero(String.valueOf(year), 4));
        rtn.append(padWithZero(String.valueOf(month), 2));
        rtn.append(padWithZero(String.valueOf(day), 2));
    ...
    public static List<DateBean> getDateBeanList(String yearMonth) throws CommonException, SQLException {
        ...
        // 祝日情報取得
        CommonUtilsDao commonUtilsDao = new CommonUtilsDao();
        List<String> shukujitsuList = commonUtilsDao.getShukujitsuList(yearMonth);
        Set<String> shukujitsuSet = new HashSet<String>();
        if (!CheckUtils.isEmpty(shukujitsuList)) {
            shukujitsuSet.addAll(shukujitsuList);
        }
        ...
        for (int i = day; i <= endDay; i++) {
            ...
            switch (calendar.get(Calendar.DAY_OF_WEEK)) {
              case Calendar.SUNDAY:
                  ...
                  dateBean.setYoubiEnum(DayOfWeek.SUNDAY);
                  break;
              case Calendar.MONDAY:
                  dow.append(DayOfWeek.MONDAY.getRyaku());
                  dateBean.setYoubiEnum(DayOfWeek.MONDAY);
                  break;
              case Calendar.TUESDAY:
                  dow.append(DayOfWeek.TUESDAY.getRyaku());
                  dateBean.setYoubiEnum(DayOfWeek.TUESDAY);
                  break;
              case Calendar.WEDNESDAY:
                  dow.append(DayOfWeek.WEDNESDAY.getRyaku());
                  dateBean.setYoubiEnum(DayOfWeek.WEDNESDAY);
                  break;
              case Calendar.THURSDAY:
                  dow.append(DayOfWeek.THURESDAY.getRyaku());
                  dateBean.setYoubiEnum(DayOfWeek.THURESDAY);
                  break;
              case Calendar.FRIDAY:
                  dow.append(DayOfWeek.FRIDAY.getRyaku());
                  dateBean.setYoubiEnum(DayOfWeek.FRIDAY);
                  break;
              case Calendar.SATURDAY:
                  dow.append(DayOfWeek.SATURDAY.getRyaku());
    ...
    public static String add(String yearMonthDay,
                               int addYera,int addMonth,int addDate) throws CommonException {
        ...
        SimpleDateFormat sdf= new SimpleDateFormat(CommonConstant.yearMonthDayNoSl);
